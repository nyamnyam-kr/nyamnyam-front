...
export default function Update() {
    ...
    const [restaurant, setRestaurant] = useState<RestaurantModel>({id: 0, name: '', tel: 0, address: '', operateTime: '' });
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-center p-6 bg-gray-100">
            <div className="w-full max-w-md bg-white shadow-lg rounded-lg p-6">
                <h1 className="text-2xl font-bold mb-6 text-center">레스토랑 수정</h1>
                <form onSubmit={handleSubmit} className="space-y-4">
                    ...
                    <div>
                        <label htmlFor="operateTime" className="block text-sm font-medium text-gray-700">운영시간:</label>
                        <input
                            type="text"
                            id="operateTime"
                            value={restaurant.operateTime}
                            onChange={handleChange}
                            required
                            className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                        />
